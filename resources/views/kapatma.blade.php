                ...
                <div class="list-group">
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-md-8 text-right" v-text='format(borc_ortalama@extends('layouts.master')
            ...
            <div class="card-body">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            <div class="col-md-4">Ort. Vade</div>
                            <div class="col-md-8 text-right">@{{ alacak_ortalama[0].ORTALAMAVADE }}</div>
                        </div>
                    </div>
                </div>
            </div>
